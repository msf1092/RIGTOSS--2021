function z = Fnc3DStratificationSIGTOSSu2Qt(SBTs, Depth)
%The 3D stratification result is plotted here
%%
x = zeros(length(SBTs),141);
y = zeros(length(SBTs),141);
z = zeros(length(SBTs),141);
for i = 2:141
    x(:,i) = x(:,i-1) + 0.05;
end
for i = 1:141
...
% title('SIGTOSS_{(\Deltau_2/\sigma^\prime_{v0}) - Q_t}','fontsize',8)
...
% xticks([0 1 2 3 4 5 6 7]);      xticklabels({'','1c','1b','1a/3','3','2','f',''})
